...
- Paper link: [here](https://arxiv.org/pdf/1607.00653.pdf)
- Other implementation: [node2vec-c](https://github.com/xgfs/node2vec-c)
...
To run the code:
```
python3 node2vec.py --data_file youtube --output_emb_file emb.txt --mix --lr 0.2 --gpus 0 1 2 3 --batch_size 100 --negative 5
```
